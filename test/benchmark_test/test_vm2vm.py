...
def test_cross_hypervisor_ipv4(test_flow_count, test_mode, test_min_throughput_sw_remote, test_min_throughput_hw_remote):
	...
	remote_machine_op_dpservice_create_route(
		"hypervisor-1", f"{vm3_config.get_ip()}/32", 0, vm3_config.get_underly_ip(), vm3_config.get_vni())
	remote_machine_op_dpservice_create_route(
		"hypervisor-2",  f"{vm1_config.get_ip()}/32", 0, vm1_config.get_underly_ip(), vm1_config.get_vni())

	remote_machine_op_flow_test(
	...
	remote_machine_op_dpservice_delete_route(
		"hypervisor-1", f"{vm3_config.get_ip()}/32", vm3_config.get_vni())
	remote_machine_op_dpservice_delete_route(
...
def test_cross_hypervisor_ipv6(test_flow_count, test_mode, test_min_throughput_sw_remote, test_min_throughput_hw_remote):
	...
	vm3_config = get_vm_config_detail("vm3")
	remote_machine_op_dpservice_create_route(
		"hypervisor-1", f"{vm3_config.get_ipv6()}/128", 0, vm3_config.get_underly_ip(), vm3_config.get_vni())
	remote_machine_op_dpservice_create_route(
		"hypervisor-2",  f"{vm1_config.get_ipv6()}/128", 0, vm1_config.get_underly_ip(), vm1_config.get_vni())
	...
	remote_machine_op_terminate_processes("vm1")
	remote_machine_op_dpservice_delete_route(
		"hypervisor-1", f"{vm3_config.get_ipv6()}/128", vm3_config.get_vni())
	remote_machine_op_dpservice_delete_route(
		"hypervisor-2", f"{vm1_config.get_ipv6()}/128", vm1_config.get_vni())
