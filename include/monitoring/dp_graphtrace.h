...
static __rte_always_inline void dp_graphtrace_rx_burst(struct rte_node *node, void **objs, uint16_t nb_objs)
{
...
static __rte_always_inline void dp_graphtrace_drop_burst(struct rte_node *node, void **objs, uint16_t nb_objs)
{
