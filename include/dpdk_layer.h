...
#define DP_STD_RX_QUEUE_ID		(DP_NR_STD_RX_QUEUES - 1)
#define DP_STD_TX_QUEUE_ID		(DP_NR_STD_TX_QUEUES - 1)

#define DP_NR_SAMPLE_RX_QUEUES		1
#define DP_SAMPLE_RX_QUEUE_ID		(DP_NR_STD_RX_QUEUES + DP_NR_SAMPLE_RX_QUEUES - 1)

#define DP_NR_SAMPLE_MATCH_TX_QUEUES	1

#define DP_NR_NON_HAIRPIN_RX_QUEUE	(DP_NR_STD_RX_QUEUES + DP_NR_SAMPLE_RX_QUEUES)
#define DP_NR_NON_HAIRPIN_TX_QUEUE	(DP_NR_STD_TX_QUEUES + DP_NR_SAMPLE_MATCH_TX_QUEUES)

#define DP_NR_PF_HAIRPIN_RX_TX_QUEUES	1
#define DP_PF_HAIRPIN_RX_TX_QUEUE_ID	(DP_NR_STD_RX_QUEUES + DP_NR_SAMPLE_RX_QUEUES + DP_NR_PF_HAIRPIN_RX_TX_QUEUES - 1)

#define DP_NR_RESERVED_RX_QUEUES	(DP_NR_STD_RX_QUEUES + DP_NR_SAMPLE_RX_QUEUES + \
					 DP_NR_PF_HAIRPIN_RX_TX_QUEUES)
#define DP_NR_RESERVED_TX_QUEUES	(DP_NR_STD_TX_QUEUES + DP_NR_SAMPLE_MATCH_TX_QUEUES + \
					 DP_NR_PF_HAIRPIN_RX_TX_QUEUES)

#define DP_VF_HAIRPIN_RX_QUEUE_BASE_ID	(DP_NR_RESERVED_RX_QUEUES)
#define DP_VF_HAIRPIN_TX_QUEUE_BASE_ID	(DP_NR_RESERVED_TX_QUEUES)
