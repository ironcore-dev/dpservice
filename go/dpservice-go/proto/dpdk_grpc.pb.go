...
const (
	...
	DPDKironcore_ListLoadBalancers_FullMethodName        = "/dpdkironcore.v1.DPDKironcore/ListLoadBalancers"
...
func (c *dPDKironcoreClient) ListLoadBalancers(ctx context.Context, in *ListLoadBalancersRequest, opts ...grpc.CallOption) (*ListLoadBalancersResponse, error) {
	...
	err := c.cc.Invoke(ctx, DPDKironcore_ListLoadBalancers_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _DPDKironcore_ListLoadBalancers_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: DPDKironcore_ListLoadBalancers_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
