														...
														const union dp_ipv6 *ul_addr)
{
	...
	const struct rte_flow_item_ipv6 ipv6_spec = {
		.hdr.proto = proto_id,
		.hdr.src_addr.a = DP_INIT_FROM_IPV6(svc_ipv6),  // TODO better macro to use diorectly?
		.hdr.dst_addr.a = DP_INIT_FROM_IPV6(ul_addr),  // TODO better macro to use diorectly?
	};
